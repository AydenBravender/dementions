...
from fluency import ToneAnalyzer
import spacy
...
class Sita:
    ...
    def tokenization(text):
        ...
        sentences = [sentence for sentence in doc.sents] #doc.sents is an interator, we are creating a list of sentence objects at once so we do not have to reiterate doc.sents
    ...
    def find_wps(converted_file, text):
